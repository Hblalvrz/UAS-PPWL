...
<div class="flex min-h-screen">
        ...
        <div class="flex flex-1 flex-col justify-center px-8 md:px-24 py-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6" id="registerForm">
                ...
                {{-- Username --}}
                <div>
                    <label for="username" class="block mb-1 font-bold text-[#2D4559]">
                        Username*
                    </label>
                    <input
                        id="username"
                ...
                {{-- Nomor Handphone --}}
                <div>
                    <label for="phone" class="block mb-1 font-bold text-[#2D4559]">
                        Nomor Handphone*
                    </label>
                    <input
                        id="phone"
    ...
    <script>
        // JS untuk validasi dan enable button
